...
ImportVector.prototype.createLayerGroup = function() {
	...
	group += '							<i class="fa fa-caret-left"></i>';
	group += '						</button>';
	group += '					</div>';
	group += '				</div>';
	...
	$(".layertree-folder-icon").click(function(){
		if (this.parentNode.parentNode.className == 'box box-default') {
			...
			if (this.parentNode.parentNode.children[0].children[2].children[0].children[0].className == "fa fa-caret-down") {
				this.parentNode.parentNode.children[0].children[2].children[0].children[0].className = "fa fa-left";
			} else if (this.parentNode.parentNode.children[0].children[2].children[0].children[0].className == "fa fa-left"){
